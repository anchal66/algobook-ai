...
| 2026-09-08 | all | Post-ship audit (AI cost/model fit, pages, workspace, API/security, ops) + production incident (Vercel Node 20 `require(esm)` crash in firebase-admin → every API 500; fixed by pinning Node 24). Fixes and remaining items in `docs/modules/reference/AUDIT-2026-09-08.md` | Claude (Fable 5.1) |
