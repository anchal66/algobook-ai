  ...
  return (
    <main className="h-full w-full overflow-hidden bg-background text-foreground">
      <ResizablePanelGroup direction="horizontal" className="h-full w-full">
        {/* Left Panel: Question and Prompt (CORRECTED LAYOUT) */}
        <ResizablePanel defaultSize={40} minSize={25} className="flex flex-col h-full">
          {/* This div will now take up the remaining space and become scrollable */}
          ...
          {/* The form is now a direct child of the flex container, so it won't be pushed out */}
          <form onSubmit={handlePromptSubmit} className="flex-shrink-0 flex gap-2 border-t p-4">
            <Input 
